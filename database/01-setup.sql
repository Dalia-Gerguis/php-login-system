...
CREATE TABLE `users_1` (
  ...
  `email` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Users_1 email address',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Users_1 table';

--
-- Truncate table before insert `users_1`
--
